      ...
      <section className="py-16">
        ...
        About Us
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            className="grid grid-cols-2 gap-6 mx-auto max-w-4xl md:grid-cols-4"
          >
            <div className="p-6 text-center bg-sky-50 rounded-xl">
              <TrendingUp className="mx-auto mb-4 w-12 h-12 text-sky-600" />
            ...
            <div className="p-6 text-center bg-green-50 rounded-xl">
              <Globe className="mx-auto mb-4 w-12 h-12 text-green-600" />
              <h3 className="mb-2 text-2xl font-bold text-gray-900">5+</h3>
              <p className="text-gray-600">Countries Served</p>
            </div>
            <div className="p-6 text-center bg-purple-50 rounded-xl">
              <Award className="mx-auto mb-4 w-12 h-12 text-purple-600" />
              <h3 className="mb-2 text-2xl font-bold text-gray-900">10+</h3>
