...
import woodImg from "../assets/img/wooden.png";

const Home: React.FC = () => {
  const heroImages = [acrylicImg, carImg, buildingImg, woodImg];
  ...
  return (
    <div className="pt-16">
      <section className="relative text-white h-[90vh]">
        ...
        <div className="relative px-4 py-24 mx-auto max-w-7xl text-center sm:px-6 lg:px-8 lg:py-32">
          <motion.div
          ...
          >
            ...
            <p className="mx-auto mb-8 max-w-3xl text-xl text-blue-100 md:text-2xl">
              Leading manufacturer of specialty polymers and chemical solutions
              for construction, paints, inks, wood finish and industrial
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto max-w-4xl text-lg leading-relaxed text-gray-600">
              With over 10 years of expertise in polymer chemistry, VSN Polymers
              Limited has established itself as a trusted partner for businesses
              worldwide. We specialize in developing and manufacturing
              high-quality polymer solutions that meet the evolving needs of the
              construction, paint, printing, and industrial sectors.
            </p>
          </motion.div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            >
              ...
              <p className="text-gray-600">
                Cutting-edge research and development to create next-generation
                polymer solutions.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Commitment to delivering superior products and exceptional
                customer service.
              </p>
            </motion.div>
          </div>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto max-w-3xl text-lg text-gray-600">
              Discover our comprehensive range of specialized polymer solutions
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {productCategories.map((category, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-14 h-14 bg-gradient-to-r ${category.color} rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                  >
